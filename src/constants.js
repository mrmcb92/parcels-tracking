...
export const SC = {
  ...
  "Ordered":     { color: "#6366f1", bg: "rgba(99, 102, 241, 0.12)", border: "rgba(99, 102, 241, 0.30)", dot: "#6366f1" },
  "In livrare":  { color: "#f59e0b", bg: "rgba(245, 158, 11, 0.14)", border: "rgba(245, 158, 11, 0.35)", dot: "#f59e0b" },
  "În livrare":  { color: "#f59e0b", bg: "rgba(245, 158, 11, 0.14)", border: "rgba(245, 158, 11, 0.35)", dot: "#f59e0b" },
  "In delivery": { color: "#f59e0b", bg: "rgba(245, 158, 11, 0.14)", border: "rgba(245, 158, 11, 0.35)", dot: "#f59e0b" },
  "delivery":    { color: "#f59e0b", bg: "rgba(245, 158, 11, 0.14)", border: "rgba(245, 158, 11, 0.35)", dot: "#f59e0b" },
  "Delivery":    { color: "#f59e0b", bg: "rgba(245, 158, 11, 0.14)", border: "rgba(245, 158, 11, 0.35)", dot: "#f59e0b" },
  "Livrat":      { color: "#10b981", bg: "rgba(16, 185, 129, 0.14)", border: "rgba(16, 185, 129, 0.35)", dot: "#10b981" },
  "Delivered":   { color: "#10b981", bg: "rgba(16, 185, 129, 0.14)", border: "rgba(16, 185, 129, 0.35)", dot: "#10b981" },
  ...
  "Returned":    { color: "#f43f5e", bg: "rgba(244, 63, 94, 0.12)", border: "rgba(244, 63, 94, 0.30)", dot: "#f43f5e" },
};

export const SC_OUT = {
  "Pregatit":   { color: "#6366f1", bg: "rgba(99, 102, 241, 0.12)", border: "rgba(99, 102, 241, 0.30)", dot: "#6366f1" },
  "Pregătit":   { color: "#6366f1", bg: "rgba(99, 102, 241, 0.12)", border: "rgba(99, 102, 241, 0.30)", dot: "#6366f1" },
  "Preparing":  { color: "#6366f1", bg: "rgba(99, 102, 241, 0.12)", border: "rgba(99, 102, 241, 0.30)", dot: "#6366f1" },
  "Expediat":   { color: "#0ea5e9", bg: "rgba(14, 165, 233, 0.12)", border: "rgba(14, 165, 233, 0.30)", dot: "#0ea5e9" },
  "Shipped":    { color: "#0ea5e9", bg: "rgba(14, 165, 233, 0.12)", border: "rgba(14, 165, 233, 0.30)", dot: "#0ea5e9" },
  "In livrare": { color: "#f59e0b", bg: "rgba(245, 158, 11, 0.14)", border: "rgba(245, 158, 11, 0.35)", dot: "#f59e0b" },
  "În livrare": { color: "#f59e0b", bg: "rgba(245, 158, 11, 0.14)", border: "rgba(245, 158, 11, 0.35)", dot: "#f59e0b" },
  "In delivery":{ color: "#f59e0b", bg: "rgba(245, 158, 11, 0.14)", border: "rgba(245, 158, 11, 0.35)", dot: "#f59e0b" },
  "delivery":   { color: "#f59e0b", bg: "rgba(245, 158, 11, 0.14)", border: "rgba(245, 158, 11, 0.35)", dot: "#f59e0b" },
...
export const STATUS_ORDER = {"Comandat":0,"Ordered":0,"In livrare":1,"În livrare":1,"In delivery":1,"delivery":1,"Delivery":1,"Livrat":2,"Delivered":2};
export const OUT_STATUS_ORDER = {"Pregatit":0,"Pregătit":0,"Preparing":0,"Expediat":1,"Shipped":1,"In livrare":2,"În livrare":2,"In delivery":2,"delivery":2,"Delivery":2,"Livrat":3,"Delivered":3,"Retur":4,"Returned":4};
